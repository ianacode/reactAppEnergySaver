...
const Notifications= () => {
  ...
  return (
    ...
    <div className="notifications">
      ...
      <button className="vector" onClick={() => navigate('/notificationread')}>
      ...
      <div className="vector-2"onClick={() => navigate('/notificationread')}>
      ...
      <div className="vector-3"onClick={() => navigate('/notificationread')}>
